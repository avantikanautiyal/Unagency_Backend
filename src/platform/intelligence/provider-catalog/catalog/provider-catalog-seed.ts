...
export const PROVIDER_CATALOG_SEED: readonly CatalogProviderEntry[] = [
  ...
  },
  {
    ...
    models: [
      ...
      m("Gemini", "Deep research", "Campaigns"),
      m("Flow", "Creative ideation", "Campaigns"),
  ...
  },
  {
    ...
    envVarHint: "PICSART_API_KEY",
    models: [m("Picsart", "Product visualization", "Campaigns")],
  },
  {
    providerId: "freepik",
    displayName: "Freepik",
    ...
    envVarHint: "FREEPIK_API_KEY",
    models: [m("Freepik", "Brand imagery", "Campaigns")],
  },
  {
    providerId: "runway",
    displayName: "Runway",
  ...
  },
  {
    ...
    envVarHint: "HEYGEN_API_KEY",
    models: [m("Heygen", "Marketing videos", "Campaigns")],
  },
  {
    providerId: "seedance",
    ...
    envVarHint: "SEEDANCE_API_KEY",
    models: [m("Seedance 2", "Marketing videos", "Campaigns")],
  },
  {
    providerId: "wan",
    displayName: "Wan",
    ...
    envVarHint: "WAN_API_KEY",
    models: [m("Wan 2.5", "Marketing videos", "Campaigns")],
  },
  {

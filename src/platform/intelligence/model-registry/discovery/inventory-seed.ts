...
export const SEED_PROVIDERS: readonly SeedProviderEntry[] = [
  ...
  },
  {
    ...
    description: "FLUX brand and commercial image generation",
    departments: ["creative", "media"],
    modalities: ["image"],
    regions: ["global"],
    lifecycleState: "active",
    capabilities: ["image.generate"],
    defaultModelId: "flux-kontext-pro",
  },
  {
    vendor: "ideogram",
...
export const SEED_MODELS: readonly SeedModelEntry[] = [
  ...
  // Gemini
  seedMultimodal("gemini", "gemini-2.5-flash", "Gemini 2.5 Flash", "2025-05", 1048576, 8192, 0.1, 0.4, "ultra_low", "premium", ["general", "research"]),
  ...
  seedMultimodal("gemini", "gemini-2.5-pro", "Gemini 2.5 Pro", "2025-05", 1048576, 16384, 1.25, 5, "medium", "frontier", ["enterprise", "research"]),
  ...
  // Image vendors
  seedImage("blackforestlabs", "flux-kontext-pro", "FLUX Kontext Pro", "2025-01", 0, 1, 0.04, 0, "high", "frontier", ["creative"]),
  seedImage("blackforestlabs", "flux-pro-1-1", "FLUX Pro 1.1", "2025-01", 0, 1, 0.05, 0, "high", "premium", ["creative"]),

...
import { BflImageProtocol } from "../blackforestlabs/bfl-image-protocol";
...
export const BFL_IMAGE_SPEC: VerifiedImageProviderSpec = {
...
function blockedImage(
  partial: Omit<VerifiedImageProviderSpec, "vendorApiVerified" | "supportsTextToImage" | "createProtocol" | "authHeaderKind"> & {

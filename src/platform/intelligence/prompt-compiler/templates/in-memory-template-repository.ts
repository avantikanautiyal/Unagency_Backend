  ...
  return [
    {
      ...
      body: [
        ...
        "BRAND: name={{brand.name}} voice={{brand.voice}} tone={{brand.tone}} colors={{brand.colors}}",
      ...
      variables: [
        ...
        { name: "brand.name", path: "brand.name", required: false, defaultValue: "" },
        ...
        { name: "brand.colors", path: "brand.colors", required: false, defaultValue: "" },

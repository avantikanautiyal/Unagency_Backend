...
export type RuntimeExecutionModeHint = "sync" | "async" | "streaming";

export interface RuntimeCapabilityResource {
  readonly capabilityId: string;
  readonly available: boolean;
  readonly executionMode: RuntimeExecutionModeHint;
...
/**
 * Canonical inventory capability IDs (runtime / provider matrix).
 * Do not invent IDs outside this set.
 */
const INVENTORY: readonly Omit<RuntimeCapabilityResource, "available">[] = [
  {
...
): readonly RuntimeCapabilityResource[] {
...
export const RUNTIME_INVENTORY_CAPABILITY_IDS = INVENTORY.map((r) => r.capabilityId);
